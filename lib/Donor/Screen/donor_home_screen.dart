...
class _DonorHomeScreenState extends State<DonorHomeScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => CompletedAidCasesCubit()
        ..fetchCompletedAidCases(),
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor:
  ...
  Widget buildMainCampaignSlider(
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    l10n
                        .aboutAtharAssociationDescription,
                    maxLines: 4,
                    overflow:
                        TextOverflow
                            .ellipsis,
  ...
  Widget buildSupportAreasSection(
    BuildContext context,
  ) {
    final l10n =
        AppLocalizations.of(context);
  ...
  Widget buildImpactStatsRow(
    ...
    return BlocBuilder<
      ...
      builder:
        ...
        if (state
            is CompletedAidCasesSuccessState) {
          completedCases = state
              .data
        ...
        if (state
            is CompletedAidCasesErrorState) {
          completedCases =
              'لا توجد حالات مكتملة حاليا';
        }
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // ======================================
                // TEMPORARY ZAKAT CALCULATOR BUTTON
                // ======================================
                SizedBox(
                  width: double.infinity,
