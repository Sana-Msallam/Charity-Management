...
class CompletedProjectsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        const Text(
          'المشاريع المنجزة من قبل الجمعية',
          style: TextStyle(color: AppColors.onSurface, fontSize: 20, fontWeight: FontWeight.w500),
        ),
